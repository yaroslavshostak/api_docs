### Продаж/оренда земельних ділянок
...
<thead>
                ...
                <tr>
                    <td style="text-align:left">Площа приблизно від</td>
                    <td style="text-align:left">characteristic[1424][from] - characteristic[1424][to]</td>
                    <td style="text-align:center"><code>Number[]</code></td>
                </tr>
                <tr>
                    <td style="text-align:left">Площа приблизно до</td>
                ...
                <tr>
                    <td style="text-align:left">У котеджному містечку</td>
                    <td style="text-align:left">characteristic[1604]</td>
                    <td style="text-align:center"><code>Number</code></td>
                </tr>
                <tr>
                    <td style="text-align:left">Світло</td>
                ...
                <tr>
                    <td style="text-align:left">Каналізація</td>
                ...
                <tr>
                    <td style="text-align:left">Тип ціни</td>
                ...
                <tr>
                    <td style="text-align:left">Ціна/рік <strong>Оренда</strong></td>
                    <td style="text-align:left">characteristic[236][from] - characteristic[236][to]</td>
                    <td style="text-align:center"><code>Number[]</code></td>
                </tr>
                <tr>
                    <td style="text-align:left">Передоплата <strong>Оренда</strong></td>
